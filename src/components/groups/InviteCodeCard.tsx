...
export function InviteCodeCard({
  ...
  function buildWhatsAppMessage() {
    ...
    return `שלום!\n\nאני מזמין/ת אותך להצטרף${groupPart} ביישומון יזכור — לניהול אזכרות, ימי זיכרון וקברי משפחה.\n\n📲 הורד/הורידי את האפליקציה:\n${APP_URL}\n\n🔑 קוד הצטרפות לקבוצה: *${code}*\n\nלזכרם לעד 🕯️`;
  }
  ...
  return (
    <>
      ...
      >
        ...
        {/* Divider */}
        <div className="h-px mb-4" style={{ background: "linear-gradient(to right, transparent, #c9a84c50, transparent)" }} />
